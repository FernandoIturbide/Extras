...
public class VentanaDos extends JFrame {
    ...
    public VentanaDos(String title) throws HeadlessException {
        ...
        //Panel2
        String urlImagen="https://th.bing.com/th/id/R.308cec9d3b0d78e5822c512e4dfdb3cf?rik=z6i%2fK2Jrrk9v2w&pid=ImgRaw&r=0";
        ...
        try {
            ...
            ImageIcon imageIcon=new ImageIcon(imagen.getScaledInstance(200, 300, Image.SCALE_SMOOTH));
